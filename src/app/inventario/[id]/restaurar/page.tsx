...
export async function generateMetadata() {
  return authPageMetadata("Restaurar artículo");
}

export default async function RestaurarArticuloPage({
  params,
}: {
  ...
  return <TrashActionForm id={item.id} code={item.code} name={item.name} mode="restore" />;
}
