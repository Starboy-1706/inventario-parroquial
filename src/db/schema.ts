...
export const zones = pgTable("zones", {
  ...
  // Medidas del área en metros: largo × ancho (× alto opcional, útil p. ej. naves).
  dimLengthM: numeric("dim_length_m", { precision: 8, scale: 2 }),
  dimWidthM: numeric("dim_width_m", { precision: 8, scale: 2 }),
  dimHeightM: numeric("dim_height_m", { precision: 8, scale: 2 }),
...
export const items = pgTable(
  "items",
  {
    ...
    // Medidas del artículo en centímetros: largo × ancho × alto (todas opcionales).
    dimLengthCm: numeric("dim_length_cm", { precision: 10, scale: 1 }),
    dimWidthCm: numeric("dim_width_cm", { precision: 10, scale: 1 }),
    dimHeightCm: numeric("dim_height_cm", { precision: 10, scale: 1 }),
    notes: text("notes"),
